...
func main() {
	...
	// fmt.Println(freqStack.Pop()) // return 5, as 5 is the most frequent. The stack becomes [5,7,4].
	// fmt.Println(freqStack.Pop()) // return 4, as 4, 5 and 7 is the most frequent, but 4 is closest to the top. The stack becomes [5,7].
}
